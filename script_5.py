# Create JavaScript for Vercel (without WebSocket, using HTTP polling instead)
messenger_js_vercel = '''// Enclave Messenger Web - Vercel Compatible (HTTP-based)
...
with open('static/messenger-vercel.js', 'w') as f:
    f.write(messenger_js_vercel)

print("✅ Created Vercel-compatible JavaScript")